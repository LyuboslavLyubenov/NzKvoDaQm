namespace NzKvoDaQm.Tests.Services.RecipeService
{
    ...
    public class CreateRecipeServiceTests
    {
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public void CantCreateIfAttachedFilesAreNotImages()
        {
            var bindingModel = this.CreateValidRecipeBindingModel();
            bindingModel.Images[0] = "Snimka.jpg";
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public void CantCreateIfAttachedFilesAreNotImages2()
        {
            var bindingModel = this.CreateValidRecipeBindingModel();
            var validImage = bindingModel.Images[0];
            bindingModel.Images = new[]
                               {
                                    "Snimka.jpg",
                                    validImage
                               };
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public void CantCreateIfImagesAreTooLarge()
        {
            var bindingModel = this.CreateValidRecipeBindingModel();
            var validImage = bindingModel.Images[0];
            bindingModel.Images[0] = "data:image/png;base64," + new string('A', int.MaxValue);
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public void CantCreateIfNoStepsTexts()
        {
            var bindingModel = this.CreateValidRecipeBindingModel();
            bindingModel.StepsTexts = null;
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public void CantCreateIfStepsTextsEmpty()
        {
            var bindingModel = this.CreateValidRecipeBindingModel();
            bindingModel.StepsTexts = new[] { "      ", " ", null };
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public void CantCreateIfStepsTextsDoesNotContainWords()
        {
            var bindingModel = this.CreateValidRecipeBindingModel();
            bindingModel.StepsTexts = new[] { "   !@#!@#!@#   ", " $^%&*(^*%&$^#*(_)*(&*^&%^ " };
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public void CantCreateIfStepMinuteIsNegative()
        {
            var bindingModel = this.CreateValidRecipeBindingModel();
            bindingModel.StepsMinutes[0] = -10;
